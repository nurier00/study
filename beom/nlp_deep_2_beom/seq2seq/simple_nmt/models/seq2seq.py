...
class Attention(nn.Module):
    ...
    def forward(self, h_src, h_t_tgt, mask=None):
        #print('## seq2seq.Attention : forward')
...
class Encoder(nn.Module):
    ...
    def forward(self, emb):
        print('## seq2seq.Encoder : forward')
        # |emb| = (batch_size, length, word_vec_size)

        if isinstance(emb, tuple):
            x, lengths = emb
            print('## [seq2seq.Encoder] x : ', x)
            print('## [seq2seq.Encoder] lengths : ', lengths)
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src, tgt):
        print("## seq2seq.Seq2Seq.forward : start")
        ...
        print("## seq2seq.Seq2Seq.forward : encoder start")
