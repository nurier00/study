...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        self.input_size = input_size        # config : hidden size
        self.hidden_size = hidden_size      # config : hidden size
        self.output_size = output_size      # voca size
        self.n_splits = n_splits            # config : multi-head count
        self.n_enc_blocks = n_enc_blocks    # config : layer count 
        self.n_dec_blocks = n_dec_blocks    # config : layer count
